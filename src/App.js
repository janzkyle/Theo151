      ...
      <Container style={{maxWidth: '80%'}} id={'Interview'}>
        ...
        <Row style={{marginBottom: '50px'}}>
          <Col lg="12" md="12">
			...
			<p><i>
			  "I identify myself as a Roman Catholic. I was baptized and have undergone most of the sacraments under the Catholic Church."
			</i></p>
			<br/>
			<p style={{fontSize:"20px"}}><b>
				Are there points in your career where it has been difficult or almost impossible to reconcile your faith with your field of study?
			</b></p>
			<p><i>
				"No, in my career and during my adult life, I did not find any difficulty in reconciling my religious views with science. What I found and still find difficulty reconciling actually was some of the practices within the Catholic Church that seem counter to the teachings within the Holy Bible. For example, God exemplifies love. However, why is it that some people are deemed not worthy of the sacraments because of their sexuality. Does this mean that they are less worthy people to love and people only deserve love if they meet certain tenets even if these were out of their control?"
			</i></p>
			<br/>
			<p style={{fontSize:"20px"}}><b>
				Does the religion you practice have any influence or significance in your scientific field? (i.e. research, manner of teaching)
			</b></p>
			<p><i>
				"Yes. It is the basis of the Abrahamic religions, including that of the Roman Catholic Church, that there is one omniscient, omnipotent and omnipresent God. In my practice of biomedical engineering, I have found the human body design to be very efficient and robust. The intricacies of the human physiology leaves me spellbound and believing that there is indeed an all-knowing architect behind all these. I think this belief motivates me to be more curious of all the things around me. It also humbles me to the fact that I know so little and yet it inspires me to learn more about the workings of the human body."
			</i></p>
			<br/>
			<p style={{fontSize:"20px"}}><b>
				Do you attempt to keep your religious life and academic career separate or do they meld into each other?
			</b></p>
			<p><i>
				"My religious beliefs complement my academic career. As I mentioned, I find no conflict in those two. What I find conflicting most of the time is the attitude of people and religious leaders towards religion and my religious leanings and how I interpret the Holy Bible. I find that my beliefs and how I interpret the Bible complements my academic career. I find so many instances in the Bible which exemplifies how God values science and engineering."
			</i></p>
			<br/>
			<p style={{fontSize:"20px"}}><b>
				If they're intertwined, in what way do they interact with each other?
			</b></p>
			<p><i>
				"I find that my beliefs and how I interpret the Bible complements my academic career. I find so many instances in the Bible which exemplifies how God values science and engineering. For example, in Kings, there is a very detailed description of the design of the temple built under King Solomon. From the measurements of the walls to the measurement of the trimmings which would be an example of early civil and architecture down to the design of the inner rooms within the temple."
			</i></p>
			<br/>
			<p style={{fontSize:"20px"}}><b>
				Did you have any prior views on the interaction between science and religion? How did it develop throughout the years?
			</b></p>
			<p><i>
				"As a child, my views were very limited as they were formed by conservative animation shows. However, through the years, I have developed a more liberal approach embracing a loving God, a higher human being that encompasses all nationalities, sex and religious sect. Furthermore, after talking with people of other religious sect like Muslims from the Middle East, I realized how they respect Abraham, Moses, Jesus and Mary. In fact, Sulaiman is Islam for Solomon. That Islam and Christianity fall under the Abrahamic religion. Also, other non-Abrahamic religions like Buddhism also believe in higher beings. In which case, if these religions share so many characteristics, why are there so many wars fought in the name of religion?"
			</i></p>
          </Col>
